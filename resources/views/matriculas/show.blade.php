                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('turmas.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="tipo" id="tipo" required class="mt-1 block w-full border border-gray-300 rounded-md p-2">
                        </div>

                        <button type="submit" class="bg-blue-500 text-white rounded-md p-2">Cadastrar</button>
                    </form>
                </div>
            </div>
        </div>
